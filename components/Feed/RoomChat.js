...
function RoomChat() {
  return (
    <div className="shadow bg-white p-4 rounded-xl relative">
      <div
        className="flex items-stretch justify-start overflow-x-scroll scrollbar-hide space-x-2"
        style={{ width: 580 }}
      >
        <button className="border border-blue-100 rounded-full px-3 py-2 flex items-center hover:bg-blue-50 duration-300 whitespace-nowrap">
